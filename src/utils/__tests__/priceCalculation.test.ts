...
import { calculatePrice, BASE_RATES, ELEVATOR_FEE, RATE_DISTANCE_START } from '../priceCalculation';
import type { DistanceData, PriceCalculation } from '@/types/chatbot';
...
describe('Price Calculation', () => {
  describe('calculatePrice', () => {
    it('should calculate basic price for small apartment without elevator', () => {
      ...
      const expected = BASE_RATES.START_FEE + 
    ...
    it('should apply correct elevator fees based on availability', () => {
      ...
      expect(noElevator.elevatorFee).toBe(0);
    ...
    it('should handle edge case with zero volume', () => {
      ...
      expect(result.totalPrice).toBe(
        BASE_RATES.START_FEE + Math.round(10 * RATE_DISTANCE_START)
      );
    });
